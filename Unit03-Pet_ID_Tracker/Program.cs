// Pet ID Tracker Projects
// Specifications from MS Learn at the bottom
// Starter Code Provided by MS Learn
...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            // Code written as part of challenge project
            //Console.WriteLine("Challenge Project - please check back soon to see progress.");
            for(int n=0; n <= maxPets-1; n++)
            {
                if(ourAnimals[n,0] != "ID #: ")
                {
                    if(ourAnimals[n,2] == "Age: ?")
                    {
                        do
                        {
                            Console.WriteLine($"Enter an age for {ourAnimals[n,0]}");
                            readResult = Console.ReadLine();
                        }
                        while(!int.TryParse(readResult, out _));
                        ourAnimals[n,2] = "Age: " + readResult;
                        
                    }

                    if(ourAnimals[n,4] == "Physical description: ")
                    {
                        do
                        {
                        Console.WriteLine($"Enter a physical description for {ourAnimals[n,0]} (size, color, gender, weight, housebroken)");
                        readResult = Console.ReadLine();
                        }
                        while(readResult == "");
                        ourAnimals[n,4] = "Physical description: " + readResult;
                    }
        ...
        case "4":
            ...
            for(int n=0; n <= maxPets-1; n++)
            {
                if(ourAnimals[n,0] != "ID #: ")
                {
                    if(ourAnimals[n,3] == "Nickname: ")
                    {
                        do
                        {
                            Console.WriteLine($"Enter a Nickname for {ourAnimals[n,0]}");
                            readResult = Console.ReadLine();
                        }
                        while(int.TryParse(readResult, out _) || readResult == "");
                        ourAnimals[n,3] = "Nickname: " + readResult;
                        
                    }

                    if(ourAnimals[n,5] == "Personality: ")
                    {
                        do
                        {
                        Console.WriteLine($"Enter a personality description for {ourAnimals[n,0]} (likes or dislikes, tricks, energy level)");
                        readResult = Console.ReadLine();
                        }
                        while(readResult == "");
                        ourAnimals[n,5] = "Personality: " + readResult;
                    }
